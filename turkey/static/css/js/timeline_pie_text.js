...
function Opinion_timeline(query, start_ts, end_ts, pointInterval){
    ...
    this.weibo_limit_count = 1000; // 每次加载10条微博
    ...
    $("#sort_by_tfidf").click(function(){
        $("#sort_by_tfidf").css("color", "#49827E");
        $("#sort_by_total_weight").css("color", "#43b6af");
        $("#sort_by_addweight").css("color", "#43b6af");
        $("#sort_by_created_at").css("color", "#43b6af");
    ...
    $("#sort_by_total_weight").click(function(){
        $("#sort_by_tfidf").css("color", "#43b6af");
        $("#sort_by_total_weight").css("color", "#49827E");
        $("#sort_by_addweight").css("color", "#43b6af");
        $("#sort_by_created_at").css("color", "#43b6af");
    ...
    $("#sort_by_addweight").click(function(){
        $("#sort_by_tfidf").css("color", "#43b6af");
        $("#sort_by_total_weight").css("color", "#43b6af");
        $("#sort_by_addweight").css("color", "#49827E");
        $("#sort_by_created_at").css("color", "#43b6af");
    ...
    $("#sort_by_created_at").click(function(){
        ...
        $("#sort_by_total_weight").css("color", "#43b6af");
        $("#sort_by_addweight").css("color", "#43b6af");
        $("#sort_by_created_at").css("color", "#49827E");
    ...
    $("#sort_by_timestamp").click(function(){
        $("#sort_by_timestamp").css("color", "#49827E");
        $("#sort_by_weight").css("color", "#43b6af");
        that.weibo_skip = 0;
    ...
    $("#sort_by_weight").click(function(){
        $("#sort_by_weight").css("color", "#49827E");
        $("#sort_by_timestamp").css("color", "#43b6af");
        that.weibo_skip = 0;
    ...
    $("#more_c_information").click(function(){
        var ajax_url = "/news/weibo_c/?query={{topic}}&acttype=1";
        console.log(ajax_url);
        that.call_sync_ajax_request(ajax_url, that.ajax_method, Weibo_function);

        function Weibo_function(data){
            if(data.length == 0){
                $("#more_c_information").html("……");
            }
            else{
                that.weibo_skip += that.weibo_limit_count;
                refreshWeibodata(data);
...
Opinion_timeline.prototype.pull_eventriver_data = function(){
	...
	function Timeline_function(data){    //数据的处理函数
        for(var i=0; i<data["eventList"].length; i++){
            if (data["eventList"][i]["id"] == "949e4351-29fa-4621-a38d-63f965f57a59"){
                data["eventList"][i]["name"] = "传统文化保护与传承";
            }
            if (data["eventList"][i]["id"] == "38a28c2e-610f-48c5-a273-fbb214ac6e51"){
                data["eventList"][i]["name"] = "古村落保护";
            }
            if (data["eventList"][i]["id"] == "56987a70-d6dc-4dc1-a5a9-e8911eefad86"){
                data["eventList"][i]["name"] = "其他";
            }
...
function drawFishbone(data){
    ...
    for (var i=0; i < eventListdata.length; i++){
        ...
        html += "<span>转载于"+ source + "</span>&nbsp;&nbsp;<a target=\"_blank\" href=\"" + news["url"] + "\">新闻</a>";
            ...
            var option = {
                ...
                tooltip: {
                    ...
                    formatter: function (params) {
                        // console.log(params);
                        var res = '';
                        res += params["1"] + ' : '+ params["2"].toFixed(2);
                        return res; 
                    }
                },
                series: [{
    ...
    var option = {
        ...
        tooltip : {
                ...
                formatter: function (params) {
                    // console.log(query);
                    if(query == '赵实'){
                        var weibo = ['中国文联党组书记、副主席赵实，中国美协名誉主<br>席靳尚谊，中央美术学院院长范迪安，徐悲鸿之子、<br>中国人民大学徐悲鸿艺术研究院院长徐庆平等先后<br>发言。', '中国文学艺术界联合会第九届全国委员会第一次会<br>议24日下午在京举行，选出新一届领导机构，孙家<br>正连任中国文联主席。赵实等21人当选为新一届中国文联<br>副主席。','一场由中国文联、河南省委宣传部、中国音协主办的“我们的中国<br>梦送欢乐·下基层”演出活动正在兰考举行。多位艺术家为<br>兰考的父老乡亲奉献了一场文化盛宴。中国文联党组书记、副主席、书记<br>处书记赵实，等人观看了演出。','24日上午，省文联第七次代表大会、省作协第八次代<br>表大会在广州开幕。中共中央政治局委员、省委书记胡春<br>华出席会议并讲话，中国文联主席孙家正出席会议。<br>中国文联党组书记、副主席赵实，中国作协党组副书记、副主席钱小芊出<br>席会议并致贺词。','中国文联文艺志愿服务团在武都慰问演出。<br>赵实连辑观看演出']

                    }else{
                        var weibo = ['冯骥才:文化遗产抢救是一个时代性的使命,<br>是中国历史上从来没有遇到过的，我们五千年的文明<br>是一个线性的发展下来的。但是我们面临转型期，这个转<br>型有两个，对我们自己的国家是由计划经济向市场经济的过<br>度，全世界开始全球化的时代。',' 3月6日 ―3月12日，网络评论数最多的提案<br>议案 全国政协委员冯骥才：15年间160万个古<br>村落消失 全国政协委员、中国文联副主席冯骥<br>才在接受媒体采访时说，“2000年全国有<br>360万个古村落，2010年是270万个，<br>10年就消失了90万个，现在的自然村只有200万<br>个左右。” 他说，“就在我们开会的时<br>候，一天100个村落就没有了。',' 冯骥才参加文艺界别小组讨论 社会较为浮躁太多人想<br>发财 昨天，全国政协常委、中国文联副主席冯骥才<br>参加文艺界别小组讨论并在会后阐述观点。 他认为，<br>目前整个社会较浮躁，太多人想发财，最浮躁的莫过于春<br>晚抢红包环节，此举将传统习俗变质，“把春节的传统<br>文化扭曲了，变成大家都盼着天上掉馅饼”。']
                    }
                    // console.log(params)
