...
~function(){
    ...
    var infoWindow = new BMap.InfoWindow("<b style='color: red;'>公共部门工会联合会或KESK(Confederation of Public Sector Unions or KESK)</b><br/>成立于1995年12月<br/>总部位于安卡拉<br/>领导人：Lami OZGEN, Sazyie KOSE", opts);  // 创建信息窗口对象
    ...
    var infoWindow1 = new BMap.InfoWindow("<b style='color: red;'>土耳其商人和工业家联合会或TUSKON （Confederation of Businessmen and Industrialists of Turkey or TUSKON）</b><br/>成立于2005"+
    ...
    var infoWindow2 = new BMap.InfoWindow("<b style='color: red;'>革命工会联合会或DISK（Confederation of Revolutionary Workers Unions or DISK）</b><br/>成立于1967年"+
    ...
    var infoWindow3 = new BMap.InfoWindow("<b style='color: red;'>道德权利工人联合会或Hak-Is（Moral Rights Workers Union or Hak-Is）</b><br/>成立于1976年10月22日"+
    ...
    var infoWindow4 = new BMap.InfoWindow("<b style='color: red;'>土耳其雇主联合会或TISK（Turkish Confederation of Employers' Unions or TISK）</b>"+
    ...
    var infoWindow5 = new BMap.InfoWindow("<b style='color: red;'>土耳其劳工联合会（Turkish Confederation of Labor or Turk-Is）</b><br/>成立于1952年"+
    ...
    var infoWindow6 = new BMap.InfoWindow("<b style='color: red;'>土耳其商业和商品交易所联合会或TOBB（Turkish Union of Chambers of Commerce and Commodity Exchanges or TOBB）</b><br/>成立于1950年3月8日"+
    ...
    var infoWindow7 = new BMap.InfoWindow("<b style='color: red;'>独立工商者和商人协会或MUSIAD （Independent Industrialists' and Businessmen's Association or MUSIAD）</b><br/>成立于1990年5月5日"+
