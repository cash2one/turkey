...
Vcity.allCity = ['土耳其|tuerqi|teq','俄罗斯|eluosi|els', '芬兰|fenlan|fl',  '瑞典|ruidian|rd', '乌克兰|wukelan|wkl', '波兰|polan|pl',
    '伊朗|yilang|yl', '以色列|yiselie|ysl', '索马里|suomali|sml'];
...
Vcity.CitySelector.prototype = {
    ...
    inputEvent:function(){
        ...
        Vcity._m.on(this.input,'focus',function(){
            that.input.select();
            if(that.input.value == '土耳其') that.input.value = '';
        });
        Vcity._m.on(this.input,'blur',function(){
            if(that.input.value == '') that.input.value = '土耳其';
        });
