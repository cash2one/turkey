...
var get_key_url = '/news/submit_keyword/?key=';
var news_data = [{"title":"普京访问土耳其会晤埃尔多安 签署天然气管道项目协议","paragraph":"据中国之声《全球华语广播网》报道，当地时间10号，世界能源大会在土耳其伊斯坦布尔开幕。与会议相比，大家更关注的是：俄罗斯总统普京与土耳其总统埃尔多安的会晤。这是去年11月土耳其在土叙边境击落一架俄罗斯战机，双方关系降到冰点以后，俄罗斯总统首次访问土耳其。","keyword":["土耳其","俄罗斯"],"time":"2016-10-11","channel":"来源：央广网"},{"title":"13 Ekim altın fiyatları Çeyrek altın gram altın ne kadar?","paragraph":"13 Ekim altın fiyatlarında sabah saatlerinde hem düşüş hem yükseliş gözükmekte. Dolar’ın 3.10’u gördüğü saatlerde altın piyasasın genelinde düşüş gözüküyor. Gram altında ciddi oranda bir yükseliş gözükürken, çeyrek altında 0.0183’lük bir düşüş hakim. 13 Ekim’de çeyrek altın ve gram altın kaç lira oldu?","keyword":["altın fiyatlar","döviz"],"time":"2016-10-13","channel":"来源：cnntürk"},{"title":"报道称土耳其屏蔽网盘和GitHub以防止邮件泄露","paragraph":"据Turkey Blocks报道，土耳其已于上周六屏蔽了包括Google Drive、Dropbox、微软OneDrive等在内多家云存储服务（以及代码托管平台GitHub）。","keyword":["土耳其","网络"],"time":"2016-10-10","channel":"来源：cnbeta网站(台州)"},{"title":"土耳其宪兵检查站遭袭 死亡人数升至17人","paragraph":"土耳其东南部哈卡里省谢姆丁利区9日晨发生针对宪兵检查站的汽车炸弹袭击事件，已导致9名士兵和8名平民死亡，另有27人受伤。","keyword":["土耳其","汽车炸弹袭击"],"time":"2016-10-09","channel":"来源：永州日报"},{"title":"土耳其总统亲自开车视察欧亚海底隧道施工现场","paragraph":"土耳其总统埃尔多安与总理耶尔德勒姆驱车前往视察欧亚海底隧道施工现场，土耳其总统埃尔多安与总理耶尔德勒姆驱车前往视察欧亚海底隧道施工现场，将与伊斯坦布尔现有的公路、铁路合而为一。","keyword":["伊斯坦布尔","欧亚海底隧道"],"time":"2016-10-09","channel":"来源：中新网"},{"title":"土耳其一警局附近发生爆炸 致10人受伤","paragraph":"土耳其最大城市伊斯坦布尔一警察局附近6日发生摩托车炸弹爆炸事件，造成10人受伤。","keyword":["伊斯坦布尔","摩托车炸弹"],"time":"2016-10-07","channel":"来源：新华网"},{"title":"土耳其紧急状态延长3个月 1.28万名警察被停职","paragraph":"外媒称，土耳其的紧急状态将延长3个月。土耳其副总理库尔图尔穆什说，总统埃尔多安领导的内阁10月3日通过相应的延长决议。路透社10月4日报道，土耳其警方10月4日说，该国已有12801名警察因涉嫌与流亡美国的宗教
var face_data=[{"name":"cnnturk","time":"2016-10-12","paragraph":"在舍尔纳克发生的武装冲突中,一名士兵牺牲，一名士兵受伤.","channel":"来源：facebook","image":"sns_6.png"},{"name":"herkesicinCHP","time":"2016-10-12","paragraph":"伊斯坦布尔议员Eren Erdem建议法案将电力,水和天然气的增值税降至1%.","channel":"来源：facebook","image":"sns_7.png"},{"name":"anadoluajansi","time":"2016-10-13","paragraph":"一级警察局长因为涉嫌参与葛兰恐怖组织被逮捕","channel":"来源：facebook","image":"sns_8.png"},{"name":"binaliyilidirim01","time":"2016-10-09","paragraph":"朋友们,这不是一个官方的页面.所以请向和朋友交谈那样给我留言吧.我发誓只要我有能力,必将尽全力解决大家的问题.总而言之,请不要把这儿当成一个官方页面,而看成是私人页面吧.","channel":"来源：facebook","image":"sns_9.png"},{"name":"Alparslan ?EL?K","time":"2016-10-08","paragraph":"最后的战士,最后的呼吸","channel":"来源：facebook","image":"sns_10.png"}];
...
for(var i =0;i<length;i++){
    ...
    html += news_data[i]["channel"]+'&nbsp;&nbsp;&nbsp;点击量：'+click_num.toString()+'</h5></div></div>';    
...
for(var i =0;i<length;i++){
	...
	var click_num = Math.random();
    click_num = Math.ceil(click_num * 800);
	html += '<h5>'+sns_data[i]["channel"]+'&nbsp;&nbsp;&nbsp;转发量：'+click_num.toString()+'</h5></div></div>';
	$("#content_panel").append(html);
}
}
...
function draw_modal_news(news_data,length,div){
for(var i =0;i<length;i++){
  var html = '';
  html += '<div class="news_box" style="width:100%;"><a href="#"><div class="textShow"  style="font-size:14px;font-weight: bold;margin-bottom: 5px;">'+news_data[i]["title"]+'</div></a>';
  html += '<div style="color: #666;">'+news_data[i]["paragraph"]+'<h5>';
    for(var j = 0;j<news_data[i]["keyword"].length;j++){
      html += '<a href="" target="_blank">'+news_data[i]["keyword"][j]+'</a>&nbsp;&nbsp;';
    }
    html += ' </h5><h5><i>'+news_data[i]["time"]+'</i>&nbsp;&nbsp;';
    ...
    if($(".channel_current_select_text").text()=="新闻"){
      ...
      $(".catalog_current_select_text").text("全部");
       ...
       $("#catalog_form").css("display","block");
        ...
        if($(".media_current_select_text").text()=="cnntürk"){
           $("#content_panel").html('');
           draw_news(tur_data_eco,2);
           draw_news(tur_data_gov,2);
           $("#catalog").change(function(){
           	if($(".catalog_current_select_text").text()=="政治"){
           	  $("#content_panel").html('');
              draw_news(tur_data_gov,5);
             }else if($(".catalog_current_select_text").text()=="经济"){
              $("#content_panel").html('');
...
function viewmore(){
   ...
   function see_emergency(){
    window.open("/news/turkey_emergency");
   }

draw_modal_news(news_data,4,"#event_more");

function submit_keyword(){
     	var keyword = $('#input_key').val();
     	console.log(keyword);
	   var key_url = '/news/submit_keyword/?key='+keyword;
	   console.log(key_url);
